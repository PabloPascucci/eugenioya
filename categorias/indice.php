...
<body>
    ...
    <section class="sec_categorias">
        ...
        <article class="art_categorias">
            <div class="div_categorias">
                <a href="categorias.php?profesion=25" class="a_categoria"><svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#ffffff"><path d="M303-80v-149H0l189-274H94l266-377 120 170 120-170 266 377h-94l188 274H658v149H543v-149H418v149H303Zm377-209h165L656-563h89L600-769l-80 115 106 151h-94l148 214Zm-564 0h489L416-563h89L360-769 215-563h90L116-289Zm0 0h189-90 290-89 189-489Zm564 0H532h94-106 225-89 189-165Zm-137 60h115-115Zm178 0Z"/></svg></a>
                <p class="p_categoria">Guías de Turismo</p>
            </div>
            <div class="div_categorias">

...
// Verificar que los datos no esten vacios
    if (empty($nombre) || empty($correo) || empty($password_user) || empty($confirm_password)) {
...
// Prepara la consulta SQL
            $query = "INSERT INTO usuario (nombre, correo, acceso, categoria, profesion, telefono, ciudad) VALUES ('$nombre', '$correo', '$hashed_password', '$categoria', '$profesion', '$telefono', '$localidad')";
